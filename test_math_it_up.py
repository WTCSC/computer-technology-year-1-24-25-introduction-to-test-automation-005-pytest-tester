...
def test_is_even():
  ...
  """
  assert math_it_up.is_even(2) == True      # test whether output is even or odd with true or false: true = even, false = odd
...
def test_is_odd():
  ...
  """
  assert math_it_up.is_odd(0) == False   # test whether ouptut is even or odd with true or false: true = even, false = odd
...
def test_mean():
  ...
  """
  assert math_it_up.mean([5, 7]) == 6 # test whether funciton works
  assert math_it_up.mean([5, 4, 2, 9]) == 5 # test more than 2 input
  assert math_it_up.mean([5, 7, 98, 2, 12]) == 24.8  # test decimal outputs
  assert math_it_up.mean([2, 10, 9, 1, 5, 5]) == 5.333333333333333  #test irationals
...
def test_median():
  ...
  """
  assert math_it_up.median([1, 2, 3, 4, 5, 6, 7, 8, 9,]) == 5  # test odd input middle 
  assert math_it_up.median([1, 2, 3, 4, 5, 6, 8, 9]) == 4.5  # test median of even amount of inputs
...
def test_mode():
  ...
  """
  assert math_it_up.mode([2, 2, 2, 3, 4, 5, 3, 2, 5, 4]) == [2]  # test whether funciton works
  assert math_it_up.mode([1, 6, 7, 8, 5, 5, 3, 2, 6, 5, 9, 5, 5, 7]) == [5]   # test whether function can sort through random inputs
  assert math_it_up.mode([3, 3, 3, 3, 4, 4, 5, 5, 6, 6, 7, 8]) == [3]  # random 